...
namespace RE {
   ...
   //
   void TimeGlobals::GetInGameDate(InGameDate* out) {
      float time = CALL_MEMBER_FN(this, GetGameHour)();
      out->rawGameHour = time;
      out->hour = (SInt32)time;
      time = (time - out->hour) * 60.0F;
      out->minute = (SInt32)time;
      time = (time - out->minute) * 60.0F;
      out->second = (SInt32)time;
      //
      ...
      //
      out->weekday = CALL_MEMBER_FN(this, GetGameWeekdayNum)();
      out->date    = CALL_MEMBER_FN(this, GetGameDate)();
      out->month   = CALL_MEMBER_FN(this, GetGameMonthNum)();
      out->year    = CALL_MEMBER_FN(this, GetGameYear)();
   };
